...
BEGIN
  ...
  UPDATE "User" SET "pinHash" = '$2b$10$iEiOK/.pWppwHSebo/bRG.WEAy03Pwm1C.zCfKyOKpWBXmXUvVMjm', "updatedAt" = now() WHERE "tenantId" = v_tenant_id AND "name" = 'Claudia Carrillo' AND "pinHash" = 'no-login-seed';
  UPDATE "User" SET "pinHash" = '$2b$10$SmZBcpX2klTJZ0SAfgxWSeyUYyjUuo6Peif6y8/d9rkWCCtJWxNEG', "updatedAt" = now() WHERE "tenantId" = v_tenant_id AND "name" = 'Dulce Financiación' AND "pinHash" = 'no-login-seed';
  UPDATE "User" SET "pinHash" = '$2b$10$AgNb3QkVX41qoG4iE2drguqPWLVGBvI3l4u1I.SAlmJ571hgUjkTW', "updatedAt" = now() WHERE "tenantId" = v_tenant_id AND "name" = 'Inara Oliveira' AND "pinHash" = 'no-login-seed';
  UPDATE "User" SET "pinHash" = '$2b$10$dJsHps.n3u1LDJJYWfHA2uQQjFZvfKZfESDEG08l2BQFwmLFsCok.', "updatedAt" = now() WHERE "tenantId" = v_tenant_id AND "name" = 'Jadiyi Martinez' AND "pinHash" = 'no-login-seed';
  UPDATE "User" SET "pinHash" = '$2b$10$JUjxNBq0Nt8YtumhZY0xROi/5thZi0IcDrI.1EHS2iHFSIx7W2xk.', "updatedAt" = now() WHERE "tenantId" = v_tenant_id AND "name" = 'Mateo Benitez' AND "pinHash" = 'no-login-seed';
  UPDATE "User" SET "pinHash" = '$2b$10$P3ii2WW2cXmuX47rtlXQrOU6gZ99EVf6InsNgb1TX22hSSSLWEtce', "updatedAt" = now() WHERE "tenantId" = v_tenant_id AND "name" = 'Edgar Castillo' AND "pinHash" = 'no-login-seed';
  UPDATE "User" SET "pinHash" = '$2b$10$n/mAi5RIBhWZulr9uAw70.TeIy7bw/gosiq8PmpuZ0J0dkzoOIRuy', "updatedAt" = now() WHERE "tenantId" = v_tenant_id AND "name" = 'Sandra Sandoval' AND "pinHash" = 'no-login-seed';
