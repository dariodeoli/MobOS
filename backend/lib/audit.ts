...
export const ACCIONES_AUDITORIA: Record<string, string> = {
  ...
  SUPPLY_SHIPMENT_CREATED: 'Envío entrante creado',
  SUPPLY_SHIPMENT_UPDATED: 'Envío entrante actualizado',
...
export const AREAS_AUDITORIA: Record<string, string> = {
  ...
  SupplyShipment: 'Abastecimiento',
  SupplyReception: 'Abastecimiento',
  Product: 'Inventario',
