...
const preflight = await fetch(`${base}/api/payments`, { method: 'OPTIONS', headers: { Origin: 'https://app.controlaria.online', 'Access-Control-Request-Headers': 'idempotency-key' } })
