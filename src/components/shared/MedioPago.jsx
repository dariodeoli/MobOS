...
function Dinelco() {
  return (
    <svg viewBox="0 0 96 22" className="h-full w-auto" aria-label="dinelco">
      ...
      <g fill="currentColor">
        <path d="M32.6 3.4v5.2c-.7-.7-1.7-1.1-2.9-1.1-2.9 0-5 2.3-5 5.4s2.1 5.4 5 5.4c1.3 0 2.3-.5 3-1.3v1.1h3.1V3.4h-3.2Zm-2.3 12c-1.4 0-2.4-1.1-2.4-2.5s1-2.5 2.4-2.5 2.4 1.1 2.4 2.5-1 2.5-2.4 2.5Z" />
        <path d="M38.4 7.7h3.2v10.4h-3.2zM40 2.9a1.9 1.9 0 1 0 0 3.8 1.9 1.9 0 0 0 0-3.8Z" />
        <path d="M50.6 7.5c-1.2 0-2.2.4-2.8 1.2V7.7h-3.1v10.4h3.2v-5.6c0-1.3.7-2.1 1.8-2.1s1.7.7 1.7 2v5.7h3.2v-6.4c0-2.6-1.6-4.2-4-4.2Z" />
        <path d="M62.6 7.5c-3.1 0-5.4 2.3-5.4 5.4s2.3 5.4 5.6 5.4c1.8 0 3.3-.6 4.2-1.7l-2-1.9c-.5.5-1.2.8-2 .8-1.2 0-2-.5-2.4-1.6h7c0-.3.1-.6.1-1 0-3.1-2.1-5.4-5.1-5.4Zm-2.1 4.4c.3-1 1-1.6 2.1-1.6s1.8.6 2 1.6h-4.1Z" />
        <path d="M69.6 3.4h3.2v14.7h-3.2z" />
        <path d="M80.4 15.4c-1.4 0-2.4-1-2.4-2.5s1-2.5 2.4-2.5c.9 0 1.6.4 2 1.1l2.6-1.5c-.9-1.6-2.6-2.5-4.6-2.5-3.2 0-5.6 2.3-5.6 5.4s2.4 5.4 5.6 5.4c2 0 3.7-.9 4.6-2.5l-2.6-1.5c-.4.7-1.1 1.1-2 1.1Z" />
      </g>
      <circle cx="92.5" cy="16.3" r="2.2" fill={C.dinelco} />
    </svg>
  )
}
