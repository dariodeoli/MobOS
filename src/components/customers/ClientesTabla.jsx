...
import { CELDA_DATO, CELDA_ENCABEZADO, CELDA_IDENTIDAD_GRANDE, ROTULO_DATO } from '@/components/shared/tabla'
        ...
        {filas.map(row => {
          ...
          return (
            ...
            >
              ...
              <span className={CELDA_IDENTIDAD_GRANDE} title={row.name}>{row.name || 'Sin nombre'}</span>
