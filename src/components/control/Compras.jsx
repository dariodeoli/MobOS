...
<Modal open={suppliersOpen} onClose={() => { setSuppliersOpen(false); setEditingSupplier(null); setSupplierForm(null); setHistorySupplier(null) }} title="Proveedores" size="xl">
