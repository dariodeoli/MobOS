...
export default function Compras() {
  ...
  async function load() {
    ...
    try { const [purchaseRows, supplierRows] = await Promise.all([purchasesApi.list(), suppliersApi.list()]); setPurchases(purchaseRows); setSuppliers(supplierRows) }
