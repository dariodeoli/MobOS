...
export default function Compras() {
  ...
  const [newSupplier, setNewSupplier] = useState({ name: '', phone: '', city: '', department: '', address: '' })
  ...
  async function create(e) {
    ...
    try {
      ...
      if (supplierId === 'new' && !demo) {
        const created = await suppliersApi.create({ name: finalSupplierName, phone: newSupplier.phone.trim() || undefined, city: newSupplier.city.trim() || undefined, department: newSupplier.department?.trim() || undefined, address: newSupplier.address.trim() || undefined })
      ...
      setSupplierId(''); setNewSupplier({ name: '', phone: '', city: '', department: '', address: '' }); setLines([emptyLine()]); setCosts({ shippingPyg: '0', customsPyg: '0', insurancePyg: '0', taxesPyg: '0', otherCostsPyg: '0' }); setCreditEnabled(false); setDueAt(''); setSupplierReference(''); setMessage('Compra creada con costo final distribuido por línea.')
