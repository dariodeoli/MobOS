            ...
            return <div key={purchase.id}>
              ...
              >
                ...
                <span className="flex flex-wrap items-center justify-end gap-1">
                  {!demo && <Button variant="outline" className="h-8 px-2 text-xs" disabled={busy} onClick={event => { event.stopPropagation(); setAdjuntosDe(purchase) }}>Adjuntos</Button>}{purchase.status === 'DRAFT' && <Button variant="outline" className="h-8 px-2 text-xs" disabled={busy} onClick={event => { event.stopPropagation(); receive(purchase) }}>Recibir</Button>}
