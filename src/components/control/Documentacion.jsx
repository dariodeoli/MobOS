...
const AYUDA = [
  ...
  {
    modulo: 'Equipo', titulo: 'Staff, roles y PIN', ubicacion: 'Configuración → Equipo y acceso → /configuracion/equipo',
  ...
  {
    modulo: 'Equipo', titulo: 'Roles y permisos', ubicacion: 'Configuración → Equipo y acceso → Roles y permisos',
  ...
  {
    modulo: 'Configuración', titulo: 'Listas de precios', ubicacion: 'Configuración → Comercial → Listas de precios',
