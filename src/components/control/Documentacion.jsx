...
const AYUDA = [
  {
    modulo: 'Vender', titulo: 'Cargar una venta', ubicacion: 'Vender → POS → /pos',
  ...
  {
    modulo: 'Vender', titulo: 'Pagos divididos', ubicacion: 'Vender → POS · bloque de cobros',
  ...
  {
    modulo: 'Vender', titulo: 'Entrega y retiro', ubicacion: 'Vender → Pedidos → Entrega · Operación → Delivery',
  ...
  {
    modulo: 'Vender', titulo: 'Comentarios internos y menciones', ubicacion: 'Vender → Pedidos → Cronología',
  ...
  {
    modulo: 'Clientes', titulo: 'Crédito y autorizaciones del cliente', ubicacion: 'Clientes → ficha → Datos → Configuración comercial · Operación → Autorizaciones',
  ...
  {
    modulo: 'Inventario', titulo: 'Seguro por producto', ubicacion: 'Inventario → Productos → ficha → Seguro',
  ...
  {
    modulo: 'Taller', titulo: 'Registrar un caso de garantía', ubicacion: 'Operación → Taller y garantías → Garantías → Nuevo caso',
  ...
  {
    modulo: 'Taller', titulo: 'Estados y avance de la garantía', ubicacion: 'Taller → Garantías → columna Estado',
  ...
  {
    modulo: 'Taller', titulo: 'Enlace público y QR del caso', ubicacion: 'Taller → Garantías → fila → icono del enlace (· Regenerar enlace)',
  ...
  {
    modulo: 'Taller', titulo: 'Garantías en el portal del cliente', ubicacion: 'Clientes → ficha → Portal del cliente (nivel completo)',
  ...
  {
    modulo: 'Taller', titulo: 'Pipeline del taller', ubicacion: 'Operación → Taller y garantías → columna Estado',
  ...
  {
    modulo: 'Taller', titulo: 'Checklists de recepción', ubicacion: 'Taller → Nueva orden → Configurar',
  ...
  {
    modulo: 'Taller', titulo: 'Costos y utilidad de la orden', ubicacion: 'Taller → Nueva orden → Repuesto, Mano de obra y Otros',
  ...
  {
    modulo: 'Taller', titulo: 'WhatsApp por estado de la orden', ubicacion: 'Taller → fila → icono de WhatsApp (el botón chico elige la plantilla)',
  ...
  {
    modulo: 'Taller', titulo: 'Impresión de recepción y reporte', ubicacion: 'Taller → fila → iconos de impresión',
    explicacion: 'Recepción en A4 y 80 mm, reporte técnico y envío a la ticketera de la sucursal.',
    ruta: '/servicio',
  },
  {
    modulo: 'Taller', titulo: 'Pasar una garantía al taller',
    ubicacion: 'Taller → Todo → fila de la garantía → Pasar a servicio',
  ...
  {
    modulo: 'Taller', titulo: 'Servicio y garantías en una sola sección',
    ubicacion: 'Operación → Taller y garantías (pestañas Todo, Tablero, Servicio y Garantías)',
  ...
  {
    modulo: 'Inventario', titulo: 'Kardex de un producto', ubicacion: 'Inventario → Productos → ficha → Kardex',
    explicacion: 'Muestra el saldo corrido de entradas y salidas con el motivo de cada movimiento, y se puede exportar a CSV.',
    ruta: '/productos',
  },
  {
    modulo: 'Inventario', titulo: 'Importar productos', ubicacion: 'Inventario → Compras / Productos → Importar',
  ...
  {
    modulo: 'Vender', titulo: 'WhatsApp y plantillas', ubicacion: 'Vender → Plantillas → /plantillas',
  ...
  {
    modulo: 'Vender', titulo: 'Promociones y combos', ubicacion: 'Vender → Promociones → /promociones',
    explicacion: 'Reglas de descuento y combos que se aplican solos en la venta, con vigencia y auditoría.',
    ruta: '/promociones',
  },
  {
    modulo: 'Vender', titulo: 'Cotizaciones y Trade-In', ubicacion: 'Vender → Cotizaciones · Operación → Trade-In',
  ...
  {
    modulo: 'Inventario', titulo: 'Compras y proveedores', ubicacion: 'Inventario → Compras → /compras',
  ...
  {
    modulo: 'Análisis', titulo: 'Análisis y reportes', ubicacion: 'Análisis → Reportes → /analisis/reportes',
