...
<Money value={parseGsInput(counted)} /></Button></Card>}{!esDemo && cash?.id && <Card><AttachmentList entity="CASH_SESSION" entityId={cash.id} puedeSubir={!abierta} titulo="Foto del arqueo" /></Card>}<AuditoriaMedios /></div>
}
