...
export default function Inventario({ tab: tabProp, onTabChange } = {}) {
  // La pestaña activa vive en la URL de la subpágina (/inventario/reservas).
  const tabValido = next => next && INVENTARIO_TABS.includes(next) && (next !== 'alertas' || canViewAlerts)
