...
import InformeDispositivoModal from '@/components/inventory/InformeDispositivoModal'
...
<EtiquetasProductoModal open={gondolaOpen} onClose={() => setGondolaOpen(false)} productos={products} />
    <InformeDispositivoModal unit={informeDe} open={Boolean(informeDe)} onClose={() => setInformeDe(null)} onResult={(resultado) => avisarImpresion(resultado, 'Informe', 'm')} /></div>}
