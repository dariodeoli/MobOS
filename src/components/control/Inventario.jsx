...
<EtiquetasProductoModal open={gondolaOpen} onClose={() => setGondolaOpen(false)} productos={products} />
    ...
    <DocumentoUnidadModal unit={certificadoDe} tipo="certificado" open={Boolean(certificadoDe)} onClose={() => setCertificadoDe(null)} onResult={(resultado) => avisarImpresion(resultado, 'Certificado', 'm')} /></div>}
