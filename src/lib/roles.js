export const ROLE_ORDER = ['ADMIN', 'GERENTE', 'VENDEDOR', 'CAJERA']
...
export const CAPACIDADES = [
  ...
  { id: 'clientes', dominio: 'Ventas', label: 'Gestionar clientes', description: 'Ficha, direcciones, RUC, importación y seguimiento.', roles: ['ADMIN', 'GERENTE', 'VENDEDOR', 'CAJERA'] },
  ...
  { id: 'stock-venta', dominio: 'Catálogo y stock', label: 'Consultar stock e IMEI', description: 'Disponibilidad y equipos serializados al cargar la venta.', roles: ['ADMIN', 'GERENTE', 'VENDEDOR', 'CAJERA'] },
