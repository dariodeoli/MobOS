...
// - 1 o 2 tokens: tal cual ("Juan", "Juan Pérez").
// - 3 tokens: se prefiere el último ("María José Pérez" → "María Pérez").
...
export function nombreCortoCliente(name) {
  ...
  const apellido = partes.length === 3 ? partes[2] : partes[partes.length - 2]
