...
import { Aviso, Button, Card, Label, PasswordInput } from '@/components/ui'
  ...
  async function submit(event) {
    ...
    try {
      if (resetting) {
        ...
        if (!/[a-z]/.test(password) || !/[A-Z]/.test(password) || !/\d/.test(password) || !/[^A-Za-z0-9]/.test(password)) throw new Error('Necesita mayúscula, minúscula, número y símbolo.')
