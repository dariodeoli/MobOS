...
const styles = { operational: 'bg-fono/10 text-fono-dark', configured: 'bg-info/10 text-info', checking: 'bg-fore/10 text-mute', degraded: 'bg-bad/10 text-bad', restricted: 'bg-warn/10 text-warn', external: 'bg-info/10 text-info' }
const dot = { operational: 'bg-fono', configured: 'bg-info', checking: 'animate-pulse bg-ink-500', degraded: 'bg-bad', restricted: 'bg-warn', external: 'bg-info' }
