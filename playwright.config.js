...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      name: 'seller',
      testMatch: /pos-checkout\.spec\.js|pos-campos\.spec\.js|pos-pedidos\.spec\.js|pos-busqueda-global\.spec\.js|pos-cliente-portal\.spec\.js|pos-ventas-suspendidas\.spec\.js|permissions\.spec\.js|responsive\.spec\.js|public-levels\.spec\.js/,
