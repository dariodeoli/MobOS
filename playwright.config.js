  ...
  projects: [
    {
      ...
      name: 'core',
      testMatch: /auth\.spec\.js|public-tracking\.spec\.js|cliente-portal-entrada\.spec\.js|qr-unificado\.spec\.js|delivery\.spec\.js/,
    },
    {
      // Seeded seller session (PIN 2468) for POS and permissions coverage.
      name: 'seller',
      testMatch: /pos-checkout\.spec\.js|pos-campos\.spec\.js|pos-pedidos\.spec\.js|pos-busqueda-global\.spec\.js|pos-cliente-portal\.spec\.js|permissions\.spec\.js|responsive\.spec\.js|public-levels\.spec\.js/,
      use: { storageState: 'e2e/.auth/seller.json' },
    },
    {
      // Seeded owner session (PIN 1234) for control views.
      name: 'admin',
      testMatch: /admin\.spec\.js|pos-resumen-fijo\.spec\.js|public-quote-transfer\.spec\.js|impresion-remota\.spec\.js|documentos-no-fiscales\.spec\.js|selector-sucursal\.spec\.js|invitar-persona\.spec\.js|auditoria\.spec\.js|equipo-integrantes\.spec\.js|equipo-invitaciones\.spec\.js|finanzas-comisiones\.spec\.js|seguridad-cuenta\.spec\.js|precios-listas\.spec\.js|etiquetas-gondola\.spec\.js/,      use: { storageState: 'e2e/.auth/admin.json' },
    },
  ],
