  ...
  projects: [
    {
      ...
      name: 'core',
      testMatch: /auth\.spec\.js|public-tracking\.spec\.js|cliente-portal-entrada\.spec\.js|demo-finanzas\.spec\.js|delivery\.spec\.js|shell-roles\.spec\.js|demo-anonimo\.spec\.js/,
    },
    {
