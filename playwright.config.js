...
const E2E_ENV = {
  ...
  // `preview` sirve el frontend con el build de producción (`vite build` +
  // `vite preview`): lo usa la auditoría de performance (#247). Los tests
  // corren en `dev` para no pagar el build.
...
export const SMOKE_GREP = [
  ...
  // #249: el barrido responsive entra al gate (POS y Pedidos sin scroll
  ...
  projects: [
    {
      ...
      name: 'core',
      testMatch: /auth\.spec\.js|demo-autorizaciones\.spec\.js|redireccion-248\.spec\.js|public-tracking\.spec\.js|cliente-portal-entrada\.spec\.js|demo-finanzas\.spec\.js|demo-finanzas-anonimo\.spec\.js|delivery\.spec\.js|shell-roles\.spec\.js|demo-anonimo\.spec\.js|demo-imei-conciliacion\.spec\.js|pwa-version\.spec\.js|demo-crm\.spec\.js|ruc-demo\.spec\.js|ops-preview\.spec\.js/
    },
    {
      // Seeded seller session (PIN 2468) for POS and permissions coverage.
      name: 'seller',
      testMatch: /pos-checkout\.spec\.js|pos-fulfillment-borradores\.spec\.js|pos-campos\.spec\.js|pos-pedidos\.spec\.js|pos-busqueda-global\.spec\.js|pos-cliente-portal\.spec\.js|permissions\.spec\.js|responsive\.spec\.js|public-levels\.spec\.js|sesion-bloqueo\.spec\.js|qa-253-mi-cuenta\.spec\.js/,
      use: { storageState: 'e2e/.auth/seller.json' },
    },
    {
      // Seeded owner session (PIN 1234) for control views.
      name: 'admin',
      testMatch: /admin\.spec\.js|pos-resumen-fijo\.spec\.js|public-quote-transfer\.spec\.js|impresion-remota\.spec\.js|documentos-no-fiscales\.spec\.js|selector-sucursal\.spec\.js|invitar-persona\.spec\.js|auditoria\.spec\.js|equipo-integrantes\.spec\.js|equipo-invitaciones\.spec\.js|finanzas-comisiones\.spec\.js|finanzas-caja\.spec\.js|finanzas-conciliacion\.spec\.js|finanzas-ultimo-usado\.spec\.js|seguridad-cuenta\.spec\.js|precios-listas\.spec\.js|etiquetas-gondola\.spec\.js|etiquetas-unidad\.spec\.js|vendidos-comprobante-rapido\.spec\.js|traslados-etiquetas-lote\.spec\.js|qa-140-inventario\.spec\.js|campanas-recompra\.spec\.js|cobro-cuotas\.spec\.js|inventario-importacion\.spec\.js|kardex-producto\.spec\.js|inventario-unidades\.spec\.js|informe-publico-checklist\.spec\.js|servicio-tecnico\.spec\.js|inventario-pos-sync\.spec\.js|notificaciones\.spec\.js|documentacion\.spec\.js|analisis\.spec\.js|qa-253-config-grupos\.spec\.js|qa-240-portal-pedido-detalle\.spec\.js|config-comercial\.spec\.js|qa-253-equipo-acceso\.spec\.js|ia-configuracion\.spec\.js|configuracion-lote5\.spec\.js|config-seguro-limites\.spec\.js|config-guardado\.spec\.js|compras-densidad\.spec\.js|pos-qa-173\.spec\.js|imei-mock\.spec\.js|demo-publico\.spec\.js|qa-160-perfil\.spec\.js|qa-236-clientes\.spec\.js|ruc-extraccion\.spec\.js|modales-tamanos\.spec\.js|qa-148-16-menciones\.spec\.js|qa-240-valuacion\.spec\.js|dsn-241-a11y\.spec\.js|dsn-241-dominios\.spec\.js|informe-dispositivo\.spec\.js|qa-240-garantia-portal\.spec\.js|informe-publico-controles\.spec\.js|qa-249-inventario-touch\.spec\.js|qa-249-inventario-touch\.spec\.js|qa-240-informe-embebible\.spec\.js|qa-249-clientes-touch\.spec\.js|dsn-responsive-mobile\.spec\.js|perf-247\.spec\.js|qa-249-pos-touch\.spec\.js|pos-241-v2\.spec\.js|pos-241-carrito-estados\.spec\.js|qa-241-ficha-paso6\.spec\.js|pos-241-v2\.spec\.js|qa-241-clientes-v2\.spec\.js|qa-241-lote-c-tile\.spec\.js|qa-241-clientes-v2\.spec\.js|qa-241-servicio-pipeline\.spec\.js|qa-241-servicio-v2\.spec\.js|inventario-tabla-encabezado\.spec\.js|config-guardado\.spec\.js|config-seguro-limites\.spec\.js|qa-241-servicio-pipeline\.spec\.js|qa-241-servicio-v2\.spec\.js|repuestos-proveedores\.spec\.js|pos-148-s11-sin-stock\.spec\.js|pos-241-carrito-estados\.spec\.js|qa-250-buscador-dependiente\.spec\.js|config-guardado\.spec\.js|config-seguro-limites\.spec\.js|pos-148-s11-sin-stock\.spec\.js|pos-241-carrito-estados\.spec\.js|qa-241-servicio-pipeline\.spec\.js|qa-241-servicio-v2\.spec\.js|repuestos-proveedores\.spec\.js|qa-240-buscador-dispositivo\.spec\.js|pos-148-s11-sin-stock\.spec\.js|pos-241-carrito-estados\.spec\.js|qa-250-buscador-dependiente\.spec\.js|repuestos-proveedores\.spec\.js|pos-148-cobro-ux\.spec\.js|qa-240-buscador-dispositivo\.spec\.js|qa-250-buscador-dependiente\.spec\.js|repuestos-proveedores\.spec\.js|ocultos-plataforma\.spec\.js|qa-240-portal-cotizaciones\.spec\.js|menu-ia\.spec\.js|ocultos-plataforma\.spec\.js|qa-240-portal-cotizaciones\.spec\.js|qa-240-portal-vitrina\.spec\.js|qa-240-informe\.spec\.js|qa-240-portal-seguimiento\.spec\.js|qa-240-portal-avisos\.spec\.js|qa-240-portal-cotizaciones\.spec\.js|qa-240-portal-vitrina\.spec\.js|qa-240-mensajes-tienda\.spec\.js|qa-253-mi-cuenta\.spec\.js|qa-241-clientes-v2\.spec\.js|qa-241-servicio-v2\.spec\.js|qa-241-servicio-pipeline\.spec\.js|ops\.spec\.js|pos-148-s11-sin-stock\.spec\.js|qa-148-9-pos-montos\.spec\.js|qa-254-por-comprar\.spec\.js|qa-250-escaneo-recepcion\.spec\.js|qa-f6-metricas-abastecimiento\.spec\.js/,
