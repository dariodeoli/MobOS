...
export default defineConfig({
  ...
  projects: [
    ...
    },
    {
      ...
      name: 'admin',
      testMatch: /admin\.spec\.js|pos-resumen-fijo\.spec\.js|public-quote-transfer\.spec\.js|impresion-remota\.spec\.js|selector-sucursal\.spec\.js|invitar-persona\.spec\.js/,
