# QA #201/#209/#210 — Verificación post-deploy (v1.0.133)

- **Superficie verificada:** `https://app.moboss.online/demo` (demo anónima),
  versión observada **v1.0.133**.
- **Verificador reutilizable:** `scripts/qa-201-210-plataforma-produccion.mjs`
  ...
  `docs/qa/201-210-produccion/resultados.json` + 7 capturas.
- **Sin sesión real ni datos de tiendas:** solo la demo pública.

## Resultado (8/8 · 0 fallos · 0 llamadas al API · 0 errores de consola)
...
| Bloqueo en oscuro (#210) | ✅ | Sobre fondo oscuro el logo claro (`/logo-dark.svg`) | `06` |
| Bloqueo en móvil (#210) | ✅ | Tarjeta completa a 390 px con logo y avatar | `07` |
