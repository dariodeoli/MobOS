...
### Post-deploy en producción — ✅ verificado en v1.0.143

Corrida del 22/9/2026 22:02 local contra la **demo pública de producción**:
...
sellados con la **v1.0.143** (los mismos valores de la tabla de arriba: base
