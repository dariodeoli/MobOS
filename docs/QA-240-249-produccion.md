# Verificación en producción — v1.0.156 (#240 · #249)

`node scripts/qa-240-249-produccion.mjs` contra `app.moboss.online`
(24/9/2026, versión desplegada **v1.0.156**): **4/5 pasos OK**.
...
| #240 · beneficios (saldo a favor y puntos) en la cuenta | **pendiente de deploy**: la sección viaja en `slot/clientes`; se completa cuando el release que la incluya impacte en producción | — |

Resultado crudo: `docs/QA-240-249-produccion/resultados.json` (sellado con la
versión y cada medida).

> Corridas anteriores: **v1.0.154, 4/4**; **v1.0.153, 3/3**.
...
- **Beneficios (#240)**: contrato en `customer-portal.mjs` + demo en el unit;
  el paso de producción se activa post-deploy.
