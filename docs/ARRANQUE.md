...
- **Pendiente en el backlog** (issues de GitHub): #81 cobranzas por WhatsApp · #82 campañas de recompra · #83 liquidación de comisiones con comprobante · #84 índices `pg_trgm` · #85 SIFEN (facturación electrónica) · #86 POS offline-first · #87 operativo Coolify (volumen `MOBOS_STORAGE_DIR` + scheduler con `MOBOS_MAINTENANCE_TOKEN`) · #88 este compendio.
- **Otros issues abiertos de otros agentes**: #21 logo de empresa (variantes), #22 foto de perfil, #23 impresión USB físico, #24 checklists de Servicio Técnico, #56 comisiones en Finanzas, #60–#65 mejoras de auditoría, #66 bug de la página de pedido del cliente.
