...
- Fecha: 2026-09-26T08:21:23.808Z
...
- ✅ **verificación funcional: un usuario demo firma con su foto** — firma demo con foto (venía sin verificar) · capturas: 08-verificacion-firmada.jpg
- ✅ **equipo demo: nombres y correos ficticios (sin «demo»)** — 6 integrantes demo con foto · correos 35… sin «demo» (p. ej. 35800101@correo.com.py) · capturas: 09-equipo-demo.jpg
